...
class Reply extends \AppBundle\Entity\Reply implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Reply' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Reply' . "\0" . 'wording', '' . "\0" . 'AppBundle\\Entity\\Reply' . "\0" . 'valid', '' . "\0" . 'AppBundle\\Entity\\Reply' . "\0" . 'question'];
        }
