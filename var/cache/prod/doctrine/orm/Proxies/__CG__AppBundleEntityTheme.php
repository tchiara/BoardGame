 ...
 */
class Theme extends \AppBundle\Entity\Theme implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Theme' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Theme' . "\0" . 'wording', '' . "\0" . 'AppBundle\\Entity\\Theme' . "\0" . 'questions', '' . "\0" . 'AppBundle\\Entity\\Theme' . "\0" . 'games'];
        }
