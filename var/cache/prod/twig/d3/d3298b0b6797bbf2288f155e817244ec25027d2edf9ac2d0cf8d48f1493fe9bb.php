...
class __TwigTemplate_c73705bd77bd67016a5e1b35947765cbd56aac193199fbbf770b041b652abb6f extends Twig_Template
{
    ...
    <div class=\"container\">
        ...
        echo "\">Règles du Jeu</a></li>
                ...
                ";
        // line 14
        if ($this->getAttribute($this->getAttribute(($context["app"] ?? null), "session", array()), "get", array(0 => "oUser"), "method")) {
            // line 15
            ...
            echo "\">Rejoindre une partie</a></li>
                    ...
                    Bonjour ";
            // line 23
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute(($context["app"] ?? null), "session", array()), "get", array(0 => "oUser"), "method"), "emailLogin", array()), "html", null, true);
